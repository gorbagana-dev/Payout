...
# In start-validator.sh, modify the genesis command section
BOOTSTRAP_VALIDATOR_STAKE_LAMPORTS="${BOOTSTRAP_VALIDATOR_STAKE_LAMPORTS:-100000000000000000}"  # 100 million SOL
...
JSON_PROGRAM_DATA='[
  ...
  },
  {
    ...
    "path": "/agave/programs/precompiled/squads_multisig_program.so",
    "type": "upgradeable"
  },
  {
    "program": "LbVRzDTvBDEcrthxfZ4RL6yiq3uZw8bS6MwtdY6UhFQ",
    "path": "/agave/programs/lb_clmm.so",
    "type": "upgradeable"
  },
  {
    "program": "Eo7WjKq67rjJQSZxS6z3YkapzY3eMj6Xy8X5EQVn5UaB",
    "path": "/agave/programs/dynamic_amm.so",
    "type": "upgradeable"
  },
  {
    "program": "SNPmGgnywBvvrAKMLundzG6StojyHTHDLu7T4sdhP4k",
    "path": "/agave/programs/alpha_vault.so",
    "type": "upgradeable"
  },
  {
    "program": "24Uqj9JCLxUeoC3hGfh5W3s9FM9uCHDS2SG3LYwBpyTi",
    "path": "/agave/programs/dynamic_vault.so",
    "type": "upgradeable"
  },
  {
    "program": "LocpQgucEQHbqNABEYvBvwoxCPsSbG91A1QaQhQQqjn",
    "path": "/agave/programs/locker.so",
    "type": "upgradeable"
  },
  {
    "program": "dfsdo2UqvwfN8DuUVrMRNfQe11VaiNoKcMqLHVvDPzh",
    "path": "/agave/programs/dynamic_fee_sharing.so",
    "type": "upgradeable"
  }
]'
...
if [[ ! -f "$AGAVE_LEDGER_DIR/genesis.bin" && ! -f "$AGAVE_LEDGER_DIR/genesis.tar.bz2" ]]; then
    ...
    GENESIS_CMD=(
        ...
        --target-lamports-per-signature 1000000000
    ...
    AIRDROP_CSV_FILE="${AIRDROP_CSV_FILE:-/agave/airdrop.csv}"
    if [[ -f "$AIRDROP_CSV_FILE" ]]; then
        echo "Loading airdrop accounts from $AIRDROP_CSV_FILE..."
        GENESIS_CMD+=(--airdrop-accounts-file "$AIRDROP_CSV_FILE")
    fi
